#!/bin/sh
echo "Edit this script to change the path to the wired engine's headless server executable."
...
/Applications/Wired/wired-headless +set sv_hostListed 1 +set sv_allowDownload 1 +set sv_dlURL \"\" +set com_hunkmegs 128 "$@"
