...
const FILES = [
	"code/render/ral/core/ral.h",
	"code/render/ral/core/ral_backend.h",
	"code/render/ral/core/ral_command.h",
	"code/render/ral/core/ral_pipeline.h",
	"code/render/ral/core/ral_query.h",
	"code/render/ral/core/ral_resource.h",
	"code/render/ral/core/ral_swapchain.h",
	"code/render/ral/core/ral_sync.h",
	"code/render/ral/core/ral_types.h",
	"code/render/ral/backends/vulkan/ral_vulkan_backend.c",
	"code/render/ral/backends/vulkan/ral_vulkan_caps.c",
	"code/render/ral/backends/vulkan/ral_vulkan_command.c",
	"code/render/ral/backends/vulkan/ral_vulkan_internal.h",
	"code/render/ral/backends/vulkan/ral_vulkan_memory.c",
	"code/render/ral/backends/vulkan/ral_vulkan_pipeline.c",
	"code/render/ral/backends/vulkan/ral_vulkan_query.c",
	"code/render/ral/backends/vulkan/ral_vulkan_resource.c",
	"code/render/ral/backends/vulkan/ral_vulkan_swapchain.c",
	"code/render/ral/backends/vulkan/ral_vulkan_sync.c",
	"code/render/ral/backends/vulkan/pipeline_test_spv.h",
	"code/render/ral/backends/vulkan/test_shaders/pipeline_test_comp.glsl",
	"code/render/ral/backends/vulkan/test_shaders/pipeline_test_vert.glsl",
	"code/render/ral/backends/vulkan/test_shaders/pipeline_test_frag.glsl",
	"code/render/ral/backends/vulkan/test_shaders/regen.sh",
	"code/render/ral/backends/vulkan/renderer/vk_ral_textures.c",
	"code/render/ral/backends/vulkan/renderer/vk_ral_textures.h",
	"code/render/ral/backends/vulkan/renderer/tr_local.h",
	"code/render/ral/backends/vulkan/renderer/tr_common.h",
	"code/render/ral/backends/vulkan/renderer/tr_init.c",
	"code/render/ral/backends/vulkan/renderer/tr_image.c",
