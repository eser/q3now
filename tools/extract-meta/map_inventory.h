...
// map_inventory.h — collected list of assets a single map needs.
//
...
// MapInventory_Free. shader_index_t pointers (stage_maps) are NOT
// referenced from inventory_t — they're owned by the index, freed
// by ShaderIndex_Free at tool teardown.

#ifndef EXTRACT_META_MAP_INVENTORY_H
#define EXTRACT_META_MAP_INVENTORY_H
...
typedef struct {
	...
	// Raw entity lump, copied out of the BSP before Map_Free. ent_emit
...
#endif /* EXTRACT_META_MAP_INVENTORY_H */
