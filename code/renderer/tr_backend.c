...
static const void *RB_SwapBuffers( const void *data ) {
	...
	// throttle buffer swaps while a map is loading so the render thread
	// doesn't steal CPU/GPU time from BSP parse, lightmap upload and
	// shader compile. r_loadingFpsCap picks the maximum
