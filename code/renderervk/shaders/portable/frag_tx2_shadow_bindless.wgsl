...
override override_type_11_7: bool = (discard_mode == 1i);
override override_type_11_8: bool = (discard_mode == 2i);
...
fn wired_apply_sun_shadow_operand_u0028_vf3_u003b(rgb_1: ptr<function, vec3<f32>>) -> vec3<f32> {
    ...
    if override_type_11_4 {
        let _e75 = (*rgb_1);
        param_11 = _e75;
        let _e76 = frag_tex_coord2_1;
        param_12 = _e76;
        let _e77 = wired_apply_sun_shadow_u0028_vf3_u003b_vf2_u003b((&param_11), (&param_12));
        return _e77;
    }
    let _e78 = (*rgb_1);
    return _e78;
...
fn wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b(role: ptr<function, u32>, uv: ptr<function, vec2<f32>>, slot: ptr<function, i32>) -> vec4<f32> {
    ...
    if ((tex_domain & (1i << bitcast<u32>(_e91))) == 0i) {
        let _e96 = c_2;
        param_13 = _e96.xyz;
        let _e98 = sRGBToLinear_u0028_vf3_u003b((&param_13));
        c_2[0u] = _e98.x;
        c_2[1u] = _e98.y;
        c_2[2u] = _e98.z;
    }
...
fn main_1() {
    ...
    param_14 = _e94.xyz;
    let _e96 = sRGBToLinear_u0028_vf3_u003b((&param_14));
    ...
    param_16 = _e103;
    param_17 = 0i;
    let _e104 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_15), (&param_16), (&param_17));
    ...
    if override_type_11_5 {
        ...
        param_19 = _e107;
        param_20 = 1i;
        let _e108 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_18), (&param_19), (&param_20));
        color1_ = _e108;
        param_21 = 2u;
        let _e109 = frag_tex_coord2_1;
        param_22 = _e109;
        param_23 = 2i;
        let _e110 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_21), (&param_22), (&param_23));
        color2_ = _e110;
        let _e111 = color0_;
        let _e113 = color1_;
        let _e116 = color2_;
        let _e118 = ((_e111.xyz + _e113.xyz) + _e116.xyz);
        let _e120 = color0_[3u];
        let _e122 = color1_[3u];
        let _e125 = color2_[3u];
        base = vec4<f32>(_e118.x, _e118.y, _e118.z, ((_e120 * _e122) * _e125));
    } else {
        if override_type_11_6 {
            ...
            param_25 = _e131;
            param_26 = 1i;
            let _e132 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_24), (&param_25), (&param_26));
            let _e133 = frag_color0_;
            color1_1 = (_e132 * _e133);
            param_27 = 2u;
            let _e135 = frag_tex_coord2_1;
            param_28 = _e135;
            param_29 = 2i;
            let _e136 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_27), (&param_28), (&param_29));
            let _e137 = frag_color0_;
            color2_1 = (_e136 * _e137);
            let _e139 = color0_;
            let _e141 = color1_1;
            let _e144 = color2_1;
            let _e146 = ((_e139.xyz + _e141.xyz) + _e144.xyz);
            let _e148 = color0_[3u];
            let _e150 = color1_1[3u];
            let _e153 = color2_1[3u];
            base = vec4<f32>(_e146.x, _e146.y, _e146.z, ((_e148 * _e150) * _e153));
        } else {
            param_30 = 1u;
            let _e159 = frag_tex_coord1_1;
            param_31 = _e159;
            param_32 = 1i;
            let _e160 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_30), (&param_31), (&param_32));
            color1_2 = _e160;
            param_33 = 2u;
            let _e161 = frag_tex_coord2_1;
            param_34 = _e161;
            param_35 = 2i;
            let _e162 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_33), (&param_34), (&param_35));
            color2_2 = _e162;
            let _e163 = color0_;
            let _e165 = color1_2;
            let _e168 = color2_2;
            let _e170 = ((_e163.xyz * _e165.xyz) * _e168.xyz);
            base[0u] = _e170.x;
            base[1u] = _e170.y;
            base[2u] = _e170.z;
            let _e178 = color0_[3u];
            let _e180 = color1_2[3u];
            let _e183 = color2_2[3u];
            base[3u] = ((_e178 * _e180) * _e183);
        }
    }
    let _e186 = base;
    param_36 = _e186.xyz;
    let _e188 = wired_apply_sun_shadow_operand_u0028_vf3_u003b((&param_36));
    base[0u] = _e188.x;
    base[1u] = _e188.y;
    base[2u] = _e188.z;
...
@fragment 
fn main(@location(7) shadowData: vec4<f32>, @location(1) frag_tex_coord0_: vec2<f32>, @location(2) frag_tex_coord1_: vec2<f32>, @location(3) frag_tex_coord2_: vec2<f32>, @location(0) frag_color0In: vec4<f32>) -> @location(0) vec4<f32> {
