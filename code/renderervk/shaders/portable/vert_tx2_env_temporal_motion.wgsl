...
fn main_1() {
    ...
    viewer = normalize((_e80.xyz - _e82));
    let _e85 = in_normal_1;
    let _e86 = viewer;
    d = dot(_e85, _e86);
    let _e88 = in_normal_1;
    let _e91 = d;
    let _e93 = viewer;
    reflected = (((_e88.yz * 2f) * _e91) - _e93.yz);
    let _e97 = reflected[0u];
    frag_tex_coord0_[0u] = (0.5f + (_e97 * 0.5f));
    let _e102 = reflected[1u];
    frag_tex_coord0_[1u] = (0.5f - (_e102 * 0.5f));
    let _e106 = in_tex_coord1_1;
    frag_tex_coord1_ = _e106;
    let _e107 = in_tex_coord2_1;
    frag_tex_coord2_ = _e107;
    return;
}
