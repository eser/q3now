...
fn main_1() {
    ...
    frag_color0_ = _e61;
    let _e62 = in_tex_coord0_1;
    frag_tex_coord0_ = _e62;
    let _e63 = in_tex_coord1_1;
    frag_tex_coord1_ = _e63;
    let _e64 = in_tex_coord2_1;
    frag_tex_coord2_ = _e64;
...
@vertex 
fn main(@builtin(instance_index) gl_InstanceIndex: u32, @location(0) in_position: vec3<f32>, @location(5) in_normal: vec3<f32>, @location(1) in_color0_: vec4<f32>, @location(2) in_tex_coord0_: vec2<f32>, @location(3) in_tex_coord1_: vec2<f32>, @location(4) in_tex_coord2_: vec2<f32>) -> VertexOutput {
