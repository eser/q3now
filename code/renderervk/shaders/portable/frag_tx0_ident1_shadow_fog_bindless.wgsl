...
fn main_1() {
    ...
    let _e70 = unnamed.packed_indices[0i][3u];
    let _e76 = unnamed.packed_indices[0i][3u];
    let _e81 = fog_tex_coord_1;
    ...
    param_11 = _e83;
    param_12 = 0i;
    let _e84 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_10), (&param_11), (&param_12));
    color0_ = _e84;
    let _e85 = color0_;
    base = _e85;
    let _e86 = color0_;
    ...
    let _e87 = base;
    param_13 = _e87.xyz;
    let _e89 = wired_apply_sun_shadow_operand_u0028_vf3_u003b((&param_13));
    base[0u] = _e89.x;
    base[1u] = _e89.y;
    base[2u] = _e89.z;
