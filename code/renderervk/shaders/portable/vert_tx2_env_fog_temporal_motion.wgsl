...
fn main_1() {
    ...
    frag_color0_ = _e89;
    let _e91 = ubo.eyePos;
    let _e93 = in_position_1;
    viewer = normalize((_e91.xyz - _e93));
    let _e96 = in_normal_1;
    let _e97 = viewer;
    d = dot(_e96, _e97);
    let _e99 = in_normal_1;
    let _e102 = d;
    let _e104 = viewer;
    reflected = (((_e99.yz * 2f) * _e102) - _e104.yz);
    let _e108 = reflected[0u];
    frag_tex_coord0_[0u] = (0.5f + (_e108 * 0.5f));
    let _e113 = reflected[1u];
    frag_tex_coord0_[1u] = (0.5f - (_e113 * 0.5f));
    let _e117 = in_tex_coord1_1;
    frag_tex_coord1_ = _e117;
    let _e118 = in_tex_coord2_1;
    frag_tex_coord2_ = _e118;
