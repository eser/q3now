...
fn wired_apply_sun_shadow_operand_u0028_vf3_u003b(rgb_1: ptr<function, vec3<f32>>) -> vec3<f32> {
    ...
    if override_type_11_3 {
        ...
        param_10 = _e75;
        let _e76 = wired_apply_sun_shadow_u0028_vf3_u003b_vf2_u003b((&param_9), (&param_10));
        return _e76;
    }
    let _e77 = (*rgb_1);
    return _e77;
...
fn wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b(role: ptr<function, u32>, uv: ptr<function, vec2<f32>>, slot: ptr<function, i32>) -> vec4<f32> {
    ...
    if ((tex_domain & (1i << bitcast<u32>(_e95))) == 0i) {
        let _e100 = c_2;
        param_11 = _e100.xyz;
        let _e102 = sRGBToLinear_u0028_vf3_u003b((&param_11));
        c_2[0u] = _e102.x;
        c_2[1u] = _e102.y;
        c_2[2u] = _e102.z;
    }
...
fn main_1() {
    ...
    param_12 = _e103.xyz;
    let _e105 = sRGBToLinear_u0028_vf3_u003b((&param_12));
    let _e107 = frag_color0In_1[3u];
    frag_color0_ = vec4<f32>(_e105.x, _e105.y, _e105.z, _e107);
    param_13 = 0u;
    let _e112 = frag_tex_coord0_1;
    param_14 = _e112;
    param_15 = 0i;
    let _e113 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_13), (&param_14), (&param_15));
    let _e114 = frag_color0_;
    color0_ = (_e113 * _e114);
    if override_type_11_4 {
        ...
        param_17 = _e116;
        param_18 = 1i;
        let _e117 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_16), (&param_17), (&param_18));
        color1_ = _e117;
        let _e118 = color0_;
        let _e120 = color1_;
        ...
        if override_type_11_5 {
            ...
            color1_1 = (_e133 * _e134);
            let _e136 = color0_;
            let _e138 = color1_1;
            let _e140 = (_e136.xyz + _e138.xyz);
            let _e142 = color0_[3u];
            let _e144 = color1_1[3u];
            base = vec4<f32>(_e140.x, _e140.y, _e140.z, (_e142 * _e144));
        } else {
            param_22 = 1u;
            let _e150 = frag_tex_coord1_1;
            param_23 = _e150;
            param_24 = 1i;
            let _e151 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_22), (&param_23), (&param_24));
            color1_2 = _e151;
            let _e152 = color0_;
            let _e154 = color1_2;
    ...
    let _e169 = base;
    param_25 = _e169.xyz;
    let _e171 = wired_apply_sun_shadow_operand_u0028_vf3_u003b((&param_25));
    base[0u] = _e171.x;
    base[1u] = _e171.y;
    base[2u] = _e171.z;
    if override_type_11_6 {
        ...
        if override_type_11_7 {
            ...
            if override_type_11_8 {
                let _e196 = base[3u];
                let _e198 = fog[3u];
                base[3u] = (_e196 * (1f - _e198));
            } else {
                let _e202 = base;
                let _e203 = fog;
                let _e205 = unnamed.fogColor;
                let _e208 = fog[3u];
                base = mix(_e202, (_e203 * _e205), vec4(_e208));
            }
        }
    }
...
@fragment 
fn main(@location(7) shadowData: vec4<f32>, @location(1) frag_tex_coord0_: vec2<f32>, @location(2) frag_tex_coord1_: vec2<f32>, @location(4) fog_tex_coord: vec2<f32>, @location(0) frag_color0In: vec4<f32>) -> @location(0) vec4<f32> {
