    ...
    if override_type_12_ {
        ...
        if override_type_12_1 {
            ...
            if override_type_12_2 {
                let _e97 = base[3u];
                let _e99 = fog[3u];
                base[3u] = (_e97 * (1f - _e99));
            } else {
                let _e103 = base;
                let _e104 = fog;
                let _e106 = unnamed.fogColor;
                let _e109 = fog[3u];
                base = mix(_e103, (_e104 * _e106), vec4(_e109));
            }
        }
    }
