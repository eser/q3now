...
typedef struct
{
	...
	qboolean noFallback;   /* if qtrue, only matched when ext is explicit in the name — never tried as a fallback */
...
{
#if FEAT_IQM
	{ "iqm", R_RegisterIQM, qfalse },
#endif // FEAT_IQM
	{ "mdl", R_RegisterMDL, qfalse },
	{ "mdr", R_RegisterMDR, qfalse },
	{ "md3", R_RegisterMD3, qfalse },
	{ "bsp", R_RegisterBSP, qtrue }	/* Q1 brushmodels only — no extension fallback */
};
