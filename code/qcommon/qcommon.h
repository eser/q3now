...
#define NET_ADDRSTRMAXLEN 64	// IPv6/WiredNet address, optional scheme and port, including trailing '\0'
...
enum svc_ops_e {
	...
	// new commands, supported only by modern protocol but not legacy
