...
void Cvar_VM_Register( vmCvar_t *vmCvar, const char *varName, const char *defaultValue, int flags, int privateFlag )
{
	...
	// base) sets both flags. We unset CVAR_ROM for such cvars.
	if ((flags & (CVAR_ARCHIVE | CVAR_ROM)) == (CVAR_ARCHIVE | CVAR_ROM)) {
		Com_Log( SEV_WARN, LOG_CH(ch_system), "Unsetting CVAR_ROM from cvar '%s', "
	...
	if ( flags & INVALID_FLAGS ) {
		Com_Log( SEV_WARN, LOG_CH(ch_system), "VM tried to set invalid flags 0x%02x on cvar '%s'\n", ( flags & INVALID_FLAGS ), varName );
		flags &= ~INVALID_FLAGS;
	}
...
//===========================================================================
// Config-file write helpers — moved from common.c
//===========================================================================
