...
//a console message, fixed layout, exported to the VM
typedef struct bot_consolemessage_vm_s
{
	int handle;
	float time;									//message time
	int type;									//message type
...
int BotNextConsoleMessage(int chatstate, struct bot_consolemessage_vm_s *cm);
