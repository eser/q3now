...
/*
cl_wired_ui_hud_scoreboard.c — Scoreboard widget renderers (SCORELIST and
DUELBOARD).
*
* TRANSITION SHIM (V-13b 2026-05-25)
* ==================================
* Relocated from code/client/wired/hud/cl_wired_hud_scoreboard.c. The widget functions
* are dispatched from elements/scorelist_widget.c via ITEM_TYPE_SCORELIST_WIDGET
* (declarative 3c migration). Retire via the deferred element relocation
* workstream once the scoreboard widget moves into its final location.
*/
