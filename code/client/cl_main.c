...
void CL_Init( void ) {
	...
	cvar_t *cv = Cvar_Get( "cl_maxPing", "800", CVAR_ARCHIVE_ND );
	...
	Cvar_Get ("char", DEFAULT_MODEL, CVAR_USERINFO | CVAR_ARCHIVE_ND );
	Cvar_Get ("skin", "default", CVAR_USERINFO | CVAR_ARCHIVE_ND );
