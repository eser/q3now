...
static const weapstat_t weapStats[WP_NUM_WEAPONS] = {
	...
	// WP_LIGHTNING: 8 damage, hitscan, 50ms
	{ 8, 0, 0, 50, 0, 0.35f },
	// WP_RAILGUN: 80 damage, hitscan, 1500ms
	{ 80, 0, 0, 1500, 0, 0.4f },
	// WP_PLASMAGUN: 20 damage, 15 splash, 20 radius, 100ms, 2000 speed
...
static const int weapAmmoInv[WP_NUM_WEAPONS] = {
	...
	INVENTORY_LIGHTNINGAMMO,	// WP_LIGHTNING
	INVENTORY_SLUGS,			// WP_RAILGUN
	INVENTORY_CELLS,			// WP_PLASMAGUN
};
...
static const int weapInv[WP_NUM_WEAPONS] = {
	...
	INVENTORY_GRENADELAUNCHER,	// WP_GRENADE_LAUNCHER
	INVENTORY_ROCKETLAUNCHER,	// WP_ROCKET_LAUNCHER
	INVENTORY_LIGHTNING,		// WP_LIGHTNING
	INVENTORY_RAILGUN,			// WP_RAILGUN
	INVENTORY_PLASMAGUN,		// WP_PLASMAGUN
};
