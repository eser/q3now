...
#
# Regenerates code/render/ral/backends/vulkan/pipeline_test_spv.h from the three
...
process.stdout.write("// Regenerate with code/render/ral/backends/vulkan/test_shaders/regen.sh after editing the GLSL.\n//\n");
