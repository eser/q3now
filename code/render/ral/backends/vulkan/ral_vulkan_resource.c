...
uint32_t ralVk_FormatBPP( ralFormat_t f ) {   // uncompressed only; zero rejects compressed readback
	...
	case RAL_FORMAT_R16G16_SNORM: case RAL_FORMAT_R11G11B10_UFLOAT: case RAL_FORMAT_E5B9G9R9_UFLOAT:
	case RAL_FORMAT_R32_SFLOAT: case RAL_FORMAT_D32_SFLOAT: case RAL_FORMAT_D24_UNORM_S8_UINT:
