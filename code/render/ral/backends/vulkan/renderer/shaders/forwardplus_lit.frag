...
layout(set = 0, binding = 0) uniform UBO {
	...
	vec4 _pad_worldLightParams;        // offset 592, unused in this pass
	vec4 advancedFogColorDensity;      // offset 608: rgb + density
	vec4 advancedFogTypeFarEnabled;    // offset 624: type + farClip + enabled + pad
};
...
void main() {
	...
	// This is an additive pass: fog attenuates the accumulated direct light but
	// never contributes its colour here. The base pass owns the one colour mix.
