...
Layout matches the host beamHeaderGPU_t in code/render/ral/backends/vulkan/renderer/vk.h.
*/
...
// matches VkPrimitiveStageGPU in code/render/ral/backends/vulkan/renderer/vk.h (32 bytes).
