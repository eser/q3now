...
fn main_1() {
    ...
    if _e77 {
        let _e78 = wired_advanced_fog_amount_u0028_();
        fogAmount = _e78;
        let _e79 = base;
        let _e82 = unnamed.advancedFogColorDensity;
        let _e84 = fogAmount;
        let _e86 = mix(_e79.xyz, _e82.xyz, vec3(_e84));
        base[0u] = _e86.x;
        base[1u] = _e86.y;
        base[2u] = _e86.z;
    }
    ...
    param_4 = _e104;
    let _e105 = wiredTemporalAtestConfidence_u0028_f1_u003b((&param_4));
    param_5 = _e105;
