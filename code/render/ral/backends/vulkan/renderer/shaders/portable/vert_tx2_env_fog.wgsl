...
fn main_1() {
    ...
    viewer = normalize((_e58.xyz - _e60));
    let _e63 = in_normal_1;
    let _e64 = viewer;
    d = dot(_e63, _e64);
    let _e66 = in_normal_1;
    let _e69 = d;
    let _e71 = viewer;
    reflected = (((_e66.yz * 2f) * _e69) - _e71.yz);
    let _e75 = reflected[0u];
    frag_tex_coord0_[0u] = (0.5f + (_e75 * 0.5f));
    let _e80 = reflected[1u];
    frag_tex_coord0_[1u] = (0.5f - (_e80 * 0.5f));
    let _e84 = in_tex_coord1_1;
    frag_tex_coord1_ = _e84;
    let _e85 = in_tex_coord2_1;
    frag_tex_coord2_ = _e85;
