...
fn main_1() {
    ...
    if _e81 {
        let _e82 = wired_advanced_fog_amount_u0028_();
        fogAmount = _e82;
        let _e83 = base;
        let _e86 = unnamed.advancedFogColorDensity;
        let _e88 = fogAmount;
        let _e90 = mix(_e83.xyz, _e86.xyz, vec3(_e88));
        base[0u] = _e90.x;
        base[1u] = _e90.y;
        base[2u] = _e90.z;
    }
    ...
    param_9 = _e108;
    let _e109 = wiredTemporalAtestConfidence_u0028_f1_u003b((&param_9));
    param_10 = _e109;
