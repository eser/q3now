...
fn main_1() {
    ...
    if _e69 {
        let _e70 = wired_advanced_fog_amount_u0028_();
        fogAmount = _e70;
        let _e71 = base;
        let _e74 = unnamed.advancedFogColorDensity;
        let _e76 = fogAmount;
        let _e78 = mix(_e71.xyz, _e74.xyz, vec3(_e76));
        base[0u] = _e78.x;
        base[1u] = _e78.y;
        base[2u] = _e78.z;
    }
