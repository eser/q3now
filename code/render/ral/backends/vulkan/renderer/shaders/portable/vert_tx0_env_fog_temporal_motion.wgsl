...
fn main_1() {
    ...
    let _e85 = in_color0_1;
    frag_color0_ = _e85;
    let _e87 = ubo.eyePos;
    let _e89 = in_position_1;
    viewer = normalize((_e87.xyz - _e89));
    let _e92 = in_normal_1;
    let _e93 = viewer;
    d = dot(_e92, _e93);
    let _e95 = in_normal_1;
    let _e98 = d;
    let _e100 = viewer;
    reflected = (((_e95.yz * 2f) * _e98) - _e100.yz);
    let _e104 = reflected[0u];
    frag_tex_coord0_[0u] = (0.5f + (_e104 * 0.5f));
    let _e109 = reflected[1u];
    frag_tex_coord0_[1u] = (0.5f - (_e109 * 0.5f));
