...
fn main_1() {
    ...
    frag_color0_ = _e45;
    let _e46 = in_color1_1;
    frag_color1_ = _e46;
    let _e48 = ubo.eyePos;
    let _e50 = in_position_1;
    viewer = normalize((_e48.xyz - _e50));
    ...
    let _e59 = d;
    let _e61 = viewer;
    reflected = (((_e56.yz * 2f) * _e59) - _e61.yz);
    let _e65 = reflected[0u];
    frag_tex_coord0_[0u] = (0.5f + (_e65 * 0.5f));
    let _e70 = reflected[1u];
    frag_tex_coord0_[1u] = (0.5f - (_e70 * 0.5f));
