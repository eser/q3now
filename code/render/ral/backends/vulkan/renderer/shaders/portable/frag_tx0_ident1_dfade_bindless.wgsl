...
fn wired_boost_legacy_lightmap_u0028_vf3_u003b(rgb: ptr<function, vec3<f32>>) -> vec3<f32> {
    ...
    let _e62 = (*rgb);
    let _e65 = unnamed.worldLightParams[0u];
    boosted = (_e62 * _e65);
    let _e68 = boosted[0u];
    let _e70 = boosted[1u];
    let _e72 = boosted[2u];
    peak = max(_e68, max(_e70, _e72));
    let _e75 = peak;
    if (_e75 > 1f) {
        let _e77 = peak;
        let _e78 = boosted;
        boosted = (_e78 / vec3(_e77));
    }
    let _e81 = boosted;
    return _e81;
}
...
fn wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b(role: ptr<function, u32>, uv: ptr<function, vec2<f32>>, slot: ptr<function, i32>) -> vec4<f32> {
    ...
    if (lightmap_slot == (_e103 + 1i)) {
        let _e106 = c_1;
        param_1 = _e106.xyz;
        let _e108 = wired_boost_legacy_lightmap_u0028_vf3_u003b((&param_1));
        c_1[0u] = _e108.x;
        c_1[1u] = _e108.y;
        c_1[2u] = _e108.z;
    }
...
fn main_1() {
    ...
    param_3 = _e73;
    param_4 = 0i;
    let _e74 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_2), (&param_3), (&param_4));
    color0_ = _e74;
    let _e75 = color0_;
    base = _e75;
    if override_type_3_ {
