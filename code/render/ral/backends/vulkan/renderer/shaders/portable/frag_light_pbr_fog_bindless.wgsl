...
fn main_1() {
    ...
    let _e103 = unnamed.packed_indices[0i][1u];
    let _e109 = unnamed.packed_indices[0i][1u];
    let _e114 = fog_tex_coord_1;
    ...
    Np = _e117;
    param_5 = 0u;
    let _e118 = parallax_tc;
    param_6 = _e118;
    param_7 = 0i;
    let _e119 = wired_bl_sample_domain_u0028_u1_u003b_vf2_u003b_i1_u003b((&param_5), (&param_6), (&param_7));
    base = _e119;
    if override_type_6_ {
        if override_type_6_1 {
            let _e121 = base[3u];
            base[3u] = select(0f, 1f, (_e121 > 0f));
        } else {
            if override_type_6_2 {
                ...
                param_10 = _e128;
                let _e129 = CorrectAlpha_u0028_f1_u003b_f1_u003b_vf2_u003b((&param_8), (&param_9), (&param_10));
                base[3u] = _e129;
            } else {
                if override_type_6_3 {
                    ...
                    let _e132 = base[3u];
                    param_12 = _e132;
                    let _e133 = frag_tex_coord_1;
                    param_13 = _e133;
                    let _e134 = CorrectAlpha_u0028_f1_u003b_f1_u003b_vf2_u003b((&param_11), (&param_12), (&param_13));
                    base[3u] = _e134;
                }
            }
        }
    ...
    let _e146 = unnamed.lightColor;
    lightColorRadius = _e146;
    let _e147 = L_1;
    nL = normalize(_e147.xyz);
    let _e150 = V_1;
    nV = normalize(_e150.xyz);
    let _e153 = L_1;
    let _e155 = L_1;
    let _e159 = lightColorRadius[3u];
    intensFactor = (1f - (dot(_e153.xyz, _e155.xyz) * _e159));
    let _e162 = intensFactor;
    if (_e162 <= 0f) {
        discard;
    }
    let _e164 = lightColorRadius;
    let _e166 = intensFactor;
    intens = (_e164.xyz * _e166);
    ...
    base[1u] = _e177.y;
    base[2u] = _e177.z;
    let _e187 = unnamed.packed_indices[0i][3u];
    let _e193 = unnamed.packed_indices[0i][3u];
    let _e198 = parallax_tc;
    let _e199 = textureSample(wired_bindless_images[(_e187 & 4095u)], wired_bindless_samplers[((_e193 >> bitcast<u32>(12i)) & 255u)], _e198);
    pbr = _e199.xyz;
    let _e202 = pbr[0u];
    ao = _e202;
    let _e204 = pbr[1u];
    roughness_3 = clamp(_e204, 0.04f, 1f);
    let _e207 = pbr[2u];
    metalness = _e207;
    let _e208 = nL;
    let _e209 = nV;
    halfVec = normalize((_e208 + _e209));
    let _e212 = Np;
    let _e213 = nL;
    NdotL_1 = max(dot(_e212, _e213), 0f);
    let _e216 = Np;
    let _e217 = nV;
    NdotV_2 = max(dot(_e216, _e217), 0.001f);
    let _e220 = Np;
    let _e221 = halfVec;
    NdotH_1 = max(dot(_e220, _e221), 0f);
    let _e224 = halfVec;
    let _e225 = nV;
    HdotV = max(dot(_e224, _e225), 0f);
    ...
    let _e236 = base;
    let _e238 = metalness;
    F0_1 = mix(vec3<f32>(0.04f, 0.04f, 0.04f), _e236.xyz, vec3(_e238));
    let _e241 = NdotH_1;
    param_14 = _e241;
    let _e242 = roughness_3;
    param_15 = _e242;
    let _e243 = DistributionGGX_u0028_f1_u003b_f1_u003b((&param_14), (&param_15));
    D = _e243;
    let _e244 = NdotV_2;
    param_16 = _e244;
    let _e245 = NdotL_1;
    param_17 = _e245;
    let _e246 = roughness_3;
    param_18 = _e246;
    let _e247 = GeometrySmith_u0028_f1_u003b_f1_u003b_f1_u003b((&param_16), (&param_17), (&param_18));
    G = _e247;
    let _e248 = HdotV;
    param_19 = _e248;
    let _e249 = F0_1;
    param_20 = _e249;
    let _e250 = FresnelSchlick_u0028_f1_u003b_vf3_u003b((&param_19), (&param_20));
    F = _e250;
    let _e251 = D;
    let _e252 = G;
    let _e254 = F;
    let _e256 = NdotV_2;
    let _e258 = NdotL_1;
    specular = ((_e254 * (_e251 * _e252)) / vec3(max(((4f * _e256) * _e258), 0.001f)));
    let _e263 = F;
    let _e265 = metalness;
    kD = ((vec3<f32>(1f, 1f, 1f) - _e263) * (1f - _e265));
    let _e268 = kD;
    let _e269 = base;
    diffuseColor = ((_e268 * _e269.xyz) / vec3(3.1415927f));
    let _e274 = diffuseColor;
    let _e275 = specular;
    let _e277 = NdotL_1;
    let _e279 = intens;
    let _e280 = (((_e274 + _e275) * _e277) * _e279);
    let _e282 = base[3u];
    out_color = vec4<f32>(_e280.x, _e280.y, _e280.z, _e282);
    return;
}
