...
fn main_1() {
    ...
    let _e106 = color0_;
    base = _e106;
    let _e107 = wired_advanced_fog_enabled_u0028_();
    if _e107 {
        let _e108 = wired_advanced_fog_amount_u0028_();
        fogAmount = _e108;
        if override_type_3_6 {
            let _e109 = fogAmount;
            let _e111 = base;
            let _e113 = (_e111.xyz * (1f - _e109));
            base[0u] = _e113.x;
            base[1u] = _e113.y;
            base[2u] = _e113.z;
        } else {
        ...
        if override_type_3_9 {
            ...
            if override_type_3_10 {
                ...
                if override_type_3_11 {
                    let _e162 = base[3u];
                    let _e164 = fog[3u];
                    base[3u] = (_e162 * (1f - _e164));
                } else {
                    let _e168 = base;
                    let _e169 = fog;
                    let _e171 = unnamed.fogColor;
                    let _e174 = fog[3u];
                    base = mix(_e168, (_e169 * _e171), vec4(_e174));
                }
            }
        }
    }
    ...
    param_9 = _e188;
    let _e189 = wiredTemporalAtestConfidence_u0028_f1_u003b((&param_9));
    param_10 = _e189;
