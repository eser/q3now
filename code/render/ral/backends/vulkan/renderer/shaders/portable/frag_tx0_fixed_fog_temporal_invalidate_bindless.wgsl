...
fn main_1() {
    ...
    let _e111 = color0_;
    base = _e111;
    let _e112 = wired_advanced_fog_enabled_u0028_();
    if _e112 {
        let _e113 = wired_advanced_fog_amount_u0028_();
        fogAmount = _e113;
        if override_type_4_6 {
            let _e114 = fogAmount;
            let _e116 = base;
            let _e118 = (_e116.xyz * (1f - _e114));
            base[0u] = _e118.x;
            base[1u] = _e118.y;
            base[2u] = _e118.z;
        } else {
        ...
        if override_type_4_9 {
            ...
            if override_type_4_10 {
                ...
                if override_type_4_11 {
                    let _e167 = base[3u];
                    let _e169 = fog[3u];
                    base[3u] = (_e167 * (1f - _e169));
                } else {
                    let _e173 = base;
                    let _e174 = fog;
                    let _e176 = unnamed.fogColor;
                    let _e179 = fog[3u];
                    base = mix(_e173, (_e174 * _e176), vec4(_e179));
                }
            }
        }
    }
    ...
    param_4 = _e193;
    let _e194 = wiredTemporalAtestConfidence_u0028_f1_u003b((&param_4));
    param_5 = _e194;
