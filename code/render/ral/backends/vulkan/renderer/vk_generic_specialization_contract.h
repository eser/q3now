...
// admission additionally requires entity-SSBO transforms, an exact caller-
// declared tx0 alpha-test specialization (or no alpha test), disabled
// alpha-to-coverage/discard, and a supported texture operation.
