...
int main( void ) {
	...
	ralBindEntry_t entries[5] = {
		{ 0u, RAL_BIND_UNIFORM_BUFFER, 1u, RAL_STAGE_VERTEX, RAL_BIND_TEXTURE_VIEW_UNSPECIFIED, qfalse },
		{ 1u, RAL_BIND_STORAGE_BUFFER, 1u, RAL_STAGE_VERTEX | RAL_STAGE_FRAGMENT, RAL_BIND_TEXTURE_VIEW_UNSPECIFIED, qfalse },
		{ 3u, RAL_BIND_SAMPLED_TEXTURE, 2u, RAL_STAGE_FRAGMENT, RAL_BIND_TEXTURE_VIEW_2D, qfalse },
		{ 5u, RAL_BIND_STORAGE_TEXTURE, 1u, RAL_STAGE_COMPUTE, RAL_BIND_TEXTURE_VIEW_2D, qfalse },
		{ 7u, RAL_BIND_SAMPLER, 1u, RAL_STAGE_FRAGMENT, RAL_BIND_TEXTURE_VIEW_UNSPECIFIED, qfalse }
	};
