...
EXTRACT_SPAN("${VK}" "static ralBindGroup_t *vk_shadow_create_ral_buffer_group_candidate("
...
FOREACH(RETIRED IN ITEMS
	"qvkCreateDescriptorSetLayout" "qvkDestroyDescriptorSetLayout")
	FORBID_TEXT("${RELEASE}" "${RETIRED}" "shadow direct layout ownership")
ENDFOREACH()
...
FOREACH(NEEDLE IN ITEMS
	...
	"*outNative = (VkDescriptorSet)Ral_GetBindGroupHandle( candidate );")
...
ENDFOREACH()
FOREACH(NEEDLE IN ITEMS
	"vk_shadow_refresh_ral_buffer_group(\n\t\t\t\t\t&vk.shadowMap.ral_cascadeMvpDesc[cmd0]"
	"&vk.shadowMap.cascadeMvpDesc[cmd0]"
	"vk_shadow_refresh_ral_buffer_group(\n\t\t\t\t&vk.dlightShadow.ral_faceMvpDesc[vk.cmd_index]"
	"&vk.dlightShadow.faceMvpDesc[vk.cmd_index]"
	"vk_shadow_refresh_ral_buffer_group( &vk.cmd->ral_shadowEntMatDesc"
	"RAL_BIND_STORAGE_BUFFER, vk.cmd->ral_shadowEntMatBuf"
	"vk_shadow_refresh_ral_buffer_group( &vk.shadowMap.ral_boneDesc[fi]"
	"RAL_BIND_UNIFORM_BUFFER, vk.shadowMap.ral_boneBuf[fi]"
	"vk_shadow_refresh_ral_buffer_group(\n\t\t\t\t&vk.dlightShadow.ral_entMatDesc[vk.cmd_index]"
	"RAL_BIND_STORAGE_BUFFER,\n\t\t\t\tvk.dlightShadow.ral_entMatBuf[vk.cmd_index], 64u")
