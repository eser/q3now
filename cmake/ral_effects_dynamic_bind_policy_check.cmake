...
SET(_ral_path "${SOURCE_ROOT}/code/render/ral/backends/vulkan/ral_vulkan_dynamic_bind.c")
SET(_command_path "${SOURCE_ROOT}/code/render/ral/backends/vulkan/ral_vulkan_command.c")
...
require_text("${_vk}" "&vk.ral_bgl_effects_ubo, &vk.set_layout_effects_ubo," "effects exact direct layout")
require_text("${_effects_adopt}" "vk.effectsUbo.ral_buffer[i] = vk_effects_ubo_shadows[i].buffer;" "effects direct buffer ownership")
