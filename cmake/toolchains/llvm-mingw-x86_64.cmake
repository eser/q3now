...
#
# Proven 2026-08-13/14 (probe + hands-free rerun, macOS arm64 host): full
# artifact set — wired.x64.exe (WAMR embedded), wired-headless.x64.exe,
# 3 renderer DLLs, gamecl/gamesv.wasm — self-contained (only system DLL +
# UCRT api-set imports). One invocation requirement remains:
#   * CMAKE_INSTALL_PREFIX must be a host-style path (libjpeg-turbo package
#     config chokes on the Windows-default c:/ prefix).
# The former workarounds (stringify host-tool, LuaJIT cross args, WAMR
# platform pin, picoquic include fixes) are now IN the build: CMakeLists.txt
# cross branches + patches/picoquic-mingw/05-06.
# ─────────────────────────────────────────────────────────────────────────────
