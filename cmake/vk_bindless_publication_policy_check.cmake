...
file(READ "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_bindless_publication.c" LEDGER)
file(READ "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_bindless_publication.h" ABI)
file(READ "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_bindless_cohort.c" COHORT)
file(READ "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_bindless_cohort.h" COHORT_ABI)
file(READ "${ROOT}/tests/vk_bindless_cohort_test.c" COHORT_HOST)
file(READ "${ROOT}/code/render/ral/backends/vulkan/renderer/tr_local.h" TR_LOCAL)
file(READ "${ROOT}/code/render/ral/core/ral_resource.h" RAL_HEADER)
file(READ "${ROOT}/code/render/ral/backends/vulkan/ral_vulkan_resource.c" RAL_VULKAN)
file(READ "${ROOT}/tests/ral_vulkan_bind_group_arena_test.c" RAL_HOST)
file(GLOB RENDERER_VK_C "${ROOT}/code/render/ral/backends/vulkan/renderer/*.c")
...
foreach(source IN LISTS RENDERER_VK_C)
	if(source STREQUAL "${ROOT}/code/render/ral/backends/vulkan/renderer/vk.c"
			OR source STREQUAL "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_ral_textures.c")
		continue()
	endif()
...
endforeach()
foreach(source IN LISTS RENDERER_VK_C)
	if(source STREQUAL "${ROOT}/code/render/ral/backends/vulkan/renderer/vk_ral_textures.c")
		continue()
	endif()
