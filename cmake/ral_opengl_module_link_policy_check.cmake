...
foreach(forbidden "OpenGL.framework" "Metal.framework" "MoltenVK"
	"Vulkan.framework" "libvulkan" "libSDL3")
	string(FIND "${LINKS}" "${forbidden}" pos)
	if(NOT pos EQUAL -1)
		message(FATAL_ERROR "wired_opengl renderer gained compatibility linkage: ${forbidden}")
	endif()
endforeach()
...
foreach(symbol "_GetRefAPI" "_WiredOpenGl_GetFrameReceipt"
	"_RalOpenGl_ModuleFrameReceiptExact")
	string(REGEX MATCHALL "${symbol}" matches "${SYMBOLS}")
	list(LENGTH matches count)
	if(NOT count EQUAL 1)
		message(FATAL_ERROR "wired_opengl renderer expected one exported ${symbol}, got ${count}")
	endif()
endforeach()
message(STATUS "wired_opengl renderer symbol/link policy: PASS")
