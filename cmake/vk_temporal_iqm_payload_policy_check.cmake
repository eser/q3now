...
file(READ "${ROOT}/code/renderervk/vk_temporal_iqm_payload.c" CORE)
file(READ "${ROOT}/code/renderervk/vk_temporal_iqm_payload.h" ABI)
file(READ "${ROOT}/code/renderervk/tr_temporal_iqm_motion.h" IQM_ABI)
...
foreach(source IN LISTS PRODUCT_C)
	if(source STREQUAL "${ROOT}/code/renderervk/vk_temporal_iqm_payload.c")
		continue()
	endif()
	file(READ "${source}" source_text)
	if(source STREQUAL "${ROOT}/code/renderervk/vk_temporal_iqm_exact3_factory.c")
		foreach(needle IN ITEMS
			"VK_TemporalIqmPayloadAcquireLayoutLease"
			"VK_TemporalIqmPayloadReleaseLayoutLease")
	...
	if(source STREQUAL "${ROOT}/code/renderervk/vk_temporal_iqm_payload_authoring.c")
	...
	if(source STREQUAL "${ROOT}/code/renderervk/vk_temporal_main_activation.c")
