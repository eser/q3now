...
file(READ "${ROOT}/code/renderervk/shaders/compile_portable_manifest.mjs" GENERATOR)
file(READ "${ROOT}/code/renderer/ral/ral_webgpu_shader_catalog.mjs" CONSUMER)
...
endforeach()
foreach(NEEDLE "292" "inlineUniform).length, 15" "combinedSamplers?.length" "arrayCounts?.length" "vertexFormats?.length")
	require_text(MANIFEST_HOST "${NEEDLE}" "full portable manifest host")
endforeach()
foreach(NEEDLE "moduleCount, 292" "color_vert_spv" "hdr_histogram_comp_spv" "stale WGSL artifact")
