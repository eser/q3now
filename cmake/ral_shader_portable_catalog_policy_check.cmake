...
endforeach()
foreach(NEEDLE "294" "inlineUniform).length, 17" "combinedSamplers?.length" "arrayCounts?.length" "vertexFormats?.length")
	require_text(MANIFEST_HOST "${NEEDLE}" "full portable manifest host")
endforeach()
foreach(NEEDLE "moduleCount, 294" "color_vert_spv" "hdr_histogram_comp_spv" "stale WGSL artifact")
