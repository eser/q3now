...
file(READ "${ROOT}/code/render/frontend/tr_image_png_write.c" PNG_WRITE)
...
require_text(PNG_WRITE "png_write_text_chunk" "PNG textual metadata writer")
require_text(PNG_WRITE "\"Renderer\", rendererBackend" "actual backend metadata")
require_text(PNG_WRITE "\"RequestedRenderer\", requestedRenderer" "requested backend diagnostic")
require_text(PNG_WRITE "\"Map\", mapName" "resolved map diagnostic")
require_text(PNG_WRITE "\"r_brightness\", brightness" "visibility diagnostic")
require_text(VK_INIT "R_EncodeScreenshotPNG( buffer, width, height, \"vulkan\"" "Vulkan backend identity")
require_text(METAL_MODULE "(int)outputWidth, (int)outputHeight, \"metal\"" "Metal backend identity")
require_text(OPENGL_MODULE "s_module.config.vidWidth, s_module.config.vidHeight, \"opengl\"" "OpenGL backend identity")
require_text(RUNTIME "png_metadata.get(key)" "runtime metadata validation")
